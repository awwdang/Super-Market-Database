...
<html lang = en>
	<head>
	<title>SQL Form For Employee In Charge of Supplies</title>
	</head>
	<body>

	<form name = "Employee" method = "POST" action = "Employee_SubitemInfo.php">
	...
	<form name = "Employee" method = "POST" action = "Employee_CategoryItem.php">
